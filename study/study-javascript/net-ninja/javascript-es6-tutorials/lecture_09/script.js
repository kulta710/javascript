...
window.onload = function () {
  ...
  // Test
  // When we omit {} in our arrow function, javascript engine consider it as a return value. But there is a function, the engine execute the function and return the value of the function.
  ...
  // *** Very Important
  // When we send a function using 'function' keyword as a argument (callback function), 'this' keyword refers to that functions itself.
  var ninja = {
    name: "Shaun",
    chop (x) {
